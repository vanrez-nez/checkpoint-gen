...
export interface CheckpointGeometryConfig {
  radius: number;
  rowsPerTier: number;
...
export interface CheckpointGeometryResult {
...
class GeometryBuilder {
  ...
  constructor(private readonly config: CheckpointGeometryConfig) {}
...
export function createCheckpointGeometry(
  ...
  const builder = new GeometryBuilder(config);
